...
//	if !utils.CheckLesson(lesson, lessonNum, dayInsert.Day-1, dayInsert.Building) {
//		return false
//	}
//	var day Models.ScheduleLesson
//	//проверка на то как его вставить
//	if !utils.HasFractPart(lesson.PerWeek) {
//		day = utils.CreateDay(lesson, lesson)
...
//		lesson.PerWeek--
//	} else {
//		DenLesson := utils.FindDorNLesson(NorDLessons, lessonNum, dayInsert.Day-1, dayInsert.Building, lesson)
//		if DenLesson != nil {
//			day = utils.CreateDay(lesson, DenLesson)
//			lesson.Teacher.Week[dayInsert.Day-1].Lessons[lessonNum] = false
